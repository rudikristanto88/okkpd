			...
			public function insert($jenis = null){
				...
				if($jenis == null){
					...
					for ($i=0; $i < sizeof($nama_produk); $i++) {
						...
						$dat = array("kode_layanan"=>$kode_layanan,"kode_pendaftaran"=>$kodependaftaran,"id_identitas_usaha"=>$id_identitas_usaha,"nama_dagang"=>$nama_dagang[$i],"id_kemasan"=>$id_kemasan[$i],
					...
					if($this->model_user->insertData("layanan",$arr)){
						...
						for ($i=0; $i < sizeof($nama_produk); $i++) {
							$dat = array("id"=>null,"nama_produk_pangan"=>$nama_produk[$i],"nama_dagang"=>$nama_dagang[$i],"id_kemasan"=>$id_kemasan[$i],
