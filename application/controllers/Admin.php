...
class Admin extends MY_Controller {
  ...
  public function proses_migrasi()
  {
    ...
    if($type == 'application/wps-office.xlsx'
    ...
    || $type == 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'){
      if ( $xlsx = SimpleXLSX::parse($_FILES['form_migrasi']['tmp_name']) ) {
        ...
        foreach ($arrs as $arr) {
          ...
          $data_excel = array("nomor_sertifikat" => $arr[0],
          ...
          $data_pelaku = array('nama_pemohon' => $data_excel['nama_pelaku_usaha'],
          ...
          $data_layanan = array('kode_layanan' => $layanan,
  ...
  public function insert_struktur_organisasi(){
    ...
    public function tambah_tugas()
    {
      $data['datalogin'] = $this->session->userdata("dataLogin");
      $data['role'] = $this->model_user->getAllData("master_role");
      $this->loadVview('dashboard_view/admin/tambah_tugas',$data);
    }
