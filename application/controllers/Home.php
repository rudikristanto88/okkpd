...
class Home extends MY_Controller {
	...
	//	echo '<center><h2>Under Construction</h2><br/>Mohon bersabar untuk kepentingan optimalisasi website <br/>
		//<a href="'.base_url().'dashboard/sign_in">Login Admin</a></center><br/>';
	}
	...
	public function kontak_kami()
  {
	...
	public function info_layanan($jenis = null)
	{
		...
		if($jenis == null){
			$this->loadView('default/layanan',$data);
		}else{
			$data['jenis'] = $jenis;
			...
			$this->loadView('default/info_layanan',$data);
		}
	}
