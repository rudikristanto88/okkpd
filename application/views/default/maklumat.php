                                ...
                                <div class="columns_wrap">
                                    ...
                                    <div class="container">
                                        <div class="post_item post_item_news sc_blogger_item sc_blogger_item_last">
                                            <h4 class="post_title sc_title sc_blogger_title">Maklumat</h4>
                                            <div class="post_content sc_blogger_content">
                                                <div class="post_descr">
                                                    
                                                     <p><?php if($maklumat == null){echo 'Tidak ada data yang ditampilkan';}else{echo $data['maklumat'];}?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
