<header class="top_panel_small">
    <div class="menu_main_wrap logo_left menu_show" style="background:#bababa">
        <div class="container">
            <div class="logo">
            ...
            <div class="menu_main">
                <nav class="menu_main_nav_area">
                    <ul id="menu_main" class="menu_main_nav">
                        ...
                        <li class="menu-item">
                            <?php if($islogin){ echo "<a href='".base_url()."dashboard/logout/false'>Logout</a>"; }else{ echo "<a href='".base_url()."home/pendaftaran_online'>Login Pelaku Usaha</a>"; } ?>
                        </li>
