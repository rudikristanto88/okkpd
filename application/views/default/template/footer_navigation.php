                                        ...
                                        <div class="sc_contact_info_bottom">
                                            <div class="sc_contact_form_address_wrap">
                                                <div class="sc_contact_form_address_field">
                                                    ...
                                                    <span class="sc_contact_form_address_data"><?php if (isset($data)) {
                                                                                                    echo $data['alamat'];
                                                                                                } ?></span>
                                                </div>
                                                <div class="sc_contact_form_address_field">
                                            ...
                                            <div class="sc_socials sc_socials_size_small  color_icons">
                                                <div class="sc_socials_item">
                                                    <a href="https://twitter.com/<?php if (isset($data)) {
                                                                                        echo $data['twitter'];
                                                                                    } ?>" target="_blank" class="social_icons social_twitter icons">
                                                        <i class="fab fa-twitter" style="color:white"></i>

                                                    </a>
                                                </div>
                                                <div class="sc_socials_item">
                                                    <a href="https://www.facebook.com/<?php if (isset($data)) {
                                                                                            echo $data['facebook'];
                                                ...
                                                <div class="sc_socials_item">
                                                    <a href="https://www.instagram.com/<?php if (isset($data)) {
                                                                                            echo $data['instagram'];
