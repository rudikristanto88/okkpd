    ...
    <div class="block-header">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
          <ul class="breadcrumb breadcrumb-style">
            <li class="breadcrumb-item 	bcrumb-1">
              ...
              <li class="breadcrumb-item active">SPPB-SPAT</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="card">
            <div class="body">
              <h2 class="card-inside-title">Cetak Sertifikat SPPB-PSAT</h2>
                <div class="row clearfix">

                  <div class="col-sm-12">
                    Setting Printer : <?php if($layanan == 'pssb'){echo 'Ukuran A4, Orientasi Portrait';}else{echo 'Ukuran A4, Orientasi Landscape';} ?>
                      ...
                      <tbody id="tbody">
                        ...
                        foreach ($dokumen as $produk): ?>
                          <tr>
                            ...
                            <td><?= $produk['nama_unit'] ?></td>
                            <td><?= $produk['alamat'] ?></td>
                            <td><?= $produk['kota'] ?></td>
                            <td><?= $produk['status_kepemilikan'] ?></td>
                            <td><?= $produk['level'] ?></td>
                            <td><?= $produk['ruang_lingkup'] ?></td>
                            <td>
                              <?php
