        ...
        <div class="col-xl-6 col-lg-5 col-md-4 col-sm-12">
          <ul class="breadcrumb breadcrumb-style">
            <li class="breadcrumb-item 	bcrumb-1">
              ...
              <li class="breadcrumb-item active">Unggah Dokumen Health Certificate</li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <div class="row clearfix">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                  <div class="header">
                    <h2>
                      <strong>Dokumen Health Certificate</strong></h2><br>
                    ...
                    <div class="body">
                      ...
                      <form id="wizard_with_validation" action="<?= base_url() ?>dashboard/uploadDokumen" method="POST" class="wizard_custom" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="jenis" value="hc">

                        <h3>Unduh Surat Pernyataan Kesanggupan</h3>
                        <fieldset>
                          <a href="<?= base_url() ?>dokumen/form_kesanggupan/hc/<?= $id_layanan ?>" target="_blank" class="btn btn-info">Unduh <span class="fas fa-download"></span></a>
                        </fieldset>
<!--
                        ...
                        <h3>Sertifikat GMP/HACPP/ISO 22000</h3>
                        <fieldset>
                          <div class="file-field input-field">
                            <div class="btn">
                              <span>Upload File</span>
