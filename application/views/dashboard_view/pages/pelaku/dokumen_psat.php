        ...
        <div class="col-xl-6 col-lg-5 col-md-4 col-sm-12">
          <ul class="breadcrumb breadcrumb-style">
            <li class="breadcrumb-item 	bcrumb-1">
              ...
              <li class="breadcrumb-item active">Unggah dokumen PSAT</li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <div class="row clearfix">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                  <div class="header">
                    <h2>
                      <strong>Dokumen PSAT</strong></h2><br>
                    ...
                    <div class="body">
                      ...
                      <form id="wizard_with_validation" action="<?= base_url() ?>dashboard/uploadDokumen" method="POST" class="wizard_custom" enctype="multipart/form-data">
                        ...
                        <fieldset>
                          <a href="<?= base_url() ?>dokumen/form_kesanggupan/psat/<?= $id_layanan ?>" target="_blank" class="btn btn-info">Unduh <span class="fas fa-download"></span></a>
                        </fieldset>
                        ...
                        foreach ($daftar_dokumen as $dok) { ?>
                          ...
                          <fieldset>
                            <?php
                              if($dok['deskripsi'] != null){ ?>
                                <p><strong> Keterangan : </strong></b><br/>
                                <span> <?= $dok['deskripsi']; ?></span><br/><br/>
                              <?php }
                            ?>
                        ...
                        <!-- KOMEN KARENA ADA PERUBAHAN DOKUMEN UNTUK PSAT -->
                        <!-- <h3>Dokumen Surat Keterangan Domisili</h3>
                        <fieldset>
                          <div class="file-field input-field">
                            <div class="btn">
                              <span>Upload File</span>
                        ...
                        <h3>Dokumen Struktur Organisasi</h3>
                        <fieldset>
                          <div class="file-field input-field">
                            <div class="btn">
                              <span>Upload File</span>
                        ...
                        <h3>Akte Pendirian dan Perubahan Badan Usaha / Badan Hukum</h3>
                        <fieldset>
                          <div class="file-field input-field">
                            <div class="btn">
                              <span>Upload File</span>
                        ...
                        <h3>Surat Ijin Usaha Perdagangan (SUP)</h3>
                        <fieldset>
                          <div class="file-field input-field">
                            <div class="btn">
                              <span>Upload File</span>
                        ...
                        <h3>Dokumen Kerjasama Dengan Pemasok</h3>
                        <fieldset>
                          <div class="file-field input-field">
                            <div class="btn">
                              <span>Upload File</span>
