                    ...
                    <table class="table table-hover display" width="100%" >
                        ...
                        <tbody>
                            <tr>
                                ...
                                <input type="hidden" name="jenisuji1" value="1. Butir belah">
                                <input type="hidden" name="satuan1" value="%">
                                <input type="hidden" name="metodeuji1" value="SNI 01-3922-1995">
                                </td>
                                <td>SNI 01-3922-1995</td>
                            </tr>
                            <tr>
                                <td>2. Butir rusak</td>
                                <td>%</td>
                                ...
                                <input type="hidden" name="jenisuji2" value="2. Butir rusak">
                                <input type="hidden" name="satuan2" value="%">
                                <input type="hidden" name="metodeuji2" value="SNI 01-3922-1995">
                                </td>
                                <td>SNI 01-3922-1995</td>
                            </tr>
                            <tr>
                                ...
                                <input type="hidden" name="metodeuji3" value="SNI 01-3922-1995">
                                </td>
                                <td>SNI 01-3922-1995</td>
                            </tr>
                            <tr>
                                ...
                                <input type="hidden" name="metodeuji4" value="SNI 01-3922-1995">
                                </td>
                                <td>SNI 01-3922-1995</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <input type="hidden" name="metodeuji5" value="SNI 01-3922-1995">
                                </td>
                                <td>SNI 01-3922-1995</td>
                            </tr>
                        </tbody>
