        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
          <ul class="breadcrumb breadcrumb-style">
            <li class="breadcrumb-item 	bcrumb-1">
              ...
              <li class="breadcrumb-item active">Hasil PPC</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div >
            <div class="body">
              ...
              <h4 class="card-inside-title">Daftar Berita Acara
              <?php
                if($role_saya == 'm_teknis' && $status != 2){
                  echo '<a href="'.base_url().'dashboard/ulang_ppc/'.$uid.'" class="btn btn-warning"><button class="text-white">Ulang</button></a>';
                }
              ?>
              </h4>
              <br/>
              ...
              <!-- <div class="table-responsive-md">
                ...
                <table class="table table-hover display" id="table-datatable" >
                  ...
                  <tbody>
                    <?php $i=1; foreach ($data_form as $form): ?>
                      <tr>
                        <td>
                          <?= $i ?>.
                        </td>
