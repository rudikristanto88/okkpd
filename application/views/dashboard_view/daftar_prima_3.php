    ...
    <div class="block-header">
      ...
      <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="card">
            <div class="body">
              <h2 class="card-inside-title">Prima 3</h2>
              <form class="" action="<?= base_url("dashboard/insert/prima_3") ?>" class="text-white" method="post">
              <h2 class="card-inside-title">Identitas Usaha</h2>
                ...
                <div class="row clearfix">
                  ...
                  <div class="col-sm-12">
                    <div class="input-field">
                      <input type="hidden" name="kode_layanan" value="prima_3" readonly>
                ...
                <button type="button " class="btn btn-info waves-effect" name="button">Simpan</button>
              </form>
