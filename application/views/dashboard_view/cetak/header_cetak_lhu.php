<table width=100%>
<tr>
    <td align="left" rowspan='3' width='80px'><img width='80px' src='<?php echo base_url()?>assets/dashboard/images/jateng.png'></td>
</tr>
<tr>
    <td align="center"><p style="font-size:15px" align=center>PEMERINTAH PROVINSI JAWA TENGAH<br>
     ...
     <td align="left" rowspan='3' width='80px'><img width='80px' src='<?php echo base_url()?>assets/dashboard/images/logo_kan.png'></td>
