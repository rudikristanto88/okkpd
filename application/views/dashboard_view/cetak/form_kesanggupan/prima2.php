<?php
            ...
            $pdf->SetTitle('Form Kesanggupan Prima2');
            ...
            $html='
              ...
              <table>
                <tr>
                  <td>Nama</td>
                    <td width="30">: </td>
                    <td>'.$prima2['nama_pemohon'].'</td>
                </tr>
                <tr>
                  <td>Alamat</td>
                  <td width="30">:</td>
                  <td>'.$prima2['alamat_usaha'].'</td>
                </tr>
                <tr>
                  <td>Selaku</td>
                  <td width="30">:</td>
                  <td>'.$prima2['jabatan_pemohon'].'</td>
                </tr>
                <tr>
                  <td>di bawah ini</td>
                  <td width="30"></td>
                ...
                <tr>
                  ...
                  <td width="30">:</td>
                  <td>'.$prima2['nama_usaha'].'</td>
                </tr>
                <tr>
                  <td>Ruang Lingkup</td>
                  <td width="30">:</td>
                  <td>sertifikasi/registrasi* Prima 2 </td>
                </tr>
                <tr>
                  <td>Komoditas</td>
                  <td width="30">:</td>
              ...
              <table>
                ...
                <tr>
                  <td align="center">'.$prima2['kota'].','.$tanggal.'</td>
                </tr>
                <tr>
                  <td align="center">'.$prima2['jabatan_pemohon'].'</td>
                </tr>
                <tr>
                  <td align="center"><br><br><br><br><br><br></td>
                </tr>
                <tr>
                  <td align="center">'.$prima2['nama_pemohon'].'</td>
                </tr>
              </table>
            ...
            $pdf->Output('Form_Kesanggupan_Prima2.pdf', 'I');
?>
