<?php
            ...
            $pdf->SetTitle('Form Kesanggupan PSAT');
            ...
            $html='
              ...
              <table>
                <tr>
                  <td>Nama</td>
                    <td width="30">: </td>
                    <td>'.$psat['nama_pemohon'].'</td>
                </tr>
                <tr>
                  <td>Alamat</td>
                  <td width="30">:</td>
                  <td>'.$psat['alamat_usaha'].'</td>
                </tr>
                <tr>
                  <td>Selaku</td>
                  <td width="30">:</td>
                  <td>'.$psat['jabatan_pemohon'].'</td>
                </tr>
                <tr>
                  <td>di bawah ini</td>
                  <td width="30"></td>
                ...
                <tr>
                  ...
                  <td width="30">:</td>
                  <td>'.$psat['nama_usaha'].'</td>
                </tr>
                <tr>
                  <td>Ruang Lingkup</td>
                  <td width="30">:</td>
                  <td>sertifikasi/registrasi* PSAT </td>
                </tr>
                <tr>
                  <td>Komoditas</td>
                  <td width="30">:</td>
              ...
              <table>
                ...
                <tr>
                  <td align="center">'.$psat['kota'].', '.$tanggal.'</td>
                </tr>
                <tr>
                  <td align="center">'.$psat['jabatan_pemohon'].'</td>
                </tr>
                <tr>
                  <td align="center"><br><br><br><br><br><br></td>
                </tr>
                <tr>
                  <td align="center">'.$psat['nama_pemohon'].'</td>
                </tr>
              </table>
            ...
            $pdf->Output('Form_Kesanggupan_PSAT.pdf', 'I');
?>
