<?php
            ...
            $pdf->SetTitle('Form Kesanggupan HC');
            ...
            $html='
              ...
              <table>
                <tr>
                  <td>Nama</td>
                    <td width="30">: </td>
                    <td>'.$hc['nama_pemohon'].'</td>
                </tr>
                <tr>
                  <td>Alamat</td>
                  <td width="30">:</td>
                  <td>'.$hc['alamat_usaha'].'</td>
                </tr>
                <tr>
                  <td>Selaku</td>
                  <td width="30">:</td>
                  <td>'.$hc['jabatan_pemohon'].'</td>
                </tr>
                <tr>
                  <td>di bawah ini</td>
                  <td width="30"></td>
                ...
                <tr>
                  <td>Ruang Lingkup</td>
                  <td width="30">:</td>
                  <td>sertifikasi/registrasi* Health Certificate </td>
                </tr>
                <tr>
                  <td>Komoditas</td>
                  <td width="30">:</td>
              ...
              <table>
                ...
                <tr>
                  <td align="center">'.$hc['kota'].', '.$tanggal.'</td>
                </tr>
                <tr>
                  <td align="center">'.$hc['jabatan_pemohon'].'</td>
                </tr>
                <tr>
                  <td align="center"><br><br><br><br><br><br></td>
                </tr>
                <tr>
                  <td align="center">'.$hc['nama_pemohon'].'</td>
                </tr>
              </table>
            ...
            $pdf->Output('Form_Kesanggupan_HC.pdf', 'I');
?>
