                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <h2 class="card-inside-title">
                            ...
                            <small>Taken from
                                <a href="https://github.com/jackmoore/autosize/tree/master" target="_blank">github.com/jackmoore/autosize/tree/master</a>
                            </small>
                        </h2>
                        <div class="row clearfix">
                            <div class="col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="form-check form-check-radio disabled">
                                    <label>
                                        <input name="group1" type="radio" disabled checked />
                                        <span>Disabled radio is on</span>
                                    </label>
                                </div>
                            </div>
                        </div>
