...
<head>
  ...
  <link rel="icon" href="<?= base_url() ?>assets/default/images/jateng.png" type="image/x-icon">
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/dashboard/css/loading-bar.css" />
