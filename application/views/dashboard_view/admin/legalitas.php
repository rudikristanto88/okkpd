              ...
              <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a href="<?= base_url('admin/tambah_legalitas') ?>">Tambah</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <div class="body">
                          <?php foreach ($legalitas as $legalitas) ; ?>

                          <div class="row">
                            <?php
                            $attribute = array('style'=>'color:black');
                            echo form_open_multipart('admin/insert_legalitas',$attribute); ?>
                              <div class="col-md-12">
                                <textarea name="legalitas" id="ckeditor" style="height:500px;color:black"><?= $legalitas['legalitas']?></textarea>
