            ...
            <?php if($datalogin['kode_role'] == 'admin'){ ?>
              ...
              <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="card">
                    <div class="body">
                      <h2 class="card-inside-title">Struktur Organisasi</h2>
                      <?php
                      $attribute = array("class"=>"text-white");
                      echo form_open_multipart('admin/insert_struktur_organisasi',$attribute);?>
                        <div class="row clearfix">
                          <div class="col-sm-6">
                            <div class="input-field">
                              <div class="file-field input-field">
                                  ...
                                  <div class="file-path-wrapper">
                                      <input  class="file-path validate text-white" type="text" placeholder="Struktur Organisasi">
                                  </div>
                              </div>
                            </div>
                          </div>
