        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
          <ul class="breadcrumb breadcrumb-style">
            <li class="breadcrumb-item 	bcrumb-1">
              ...
              <li class="breadcrumb-item active">Tambah Kemasan</li>
              </ul>
          </div>
        </div>
      </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  ?>
                    <div class="card">
                        ...
                        <div class="header">
                            <h2>
                                <strong>Tambah</strong> Kemasan</h2><br/>
                                <button type="button" onclick="tambah()" class="btn btn-info" name="button">Tambah</button>


                        </div>
                        <div class="body table-responsive">
                          <form action="<?= base_url() ?>admin/data_kemasan/tambah" method="post">


                          <table class="table table-hover" >
                            <thead>
                              <tr>
                                <th style="vertical-align: middle;" >Nama Kemasan</th>
...
var jml_hapus = 0;
  function tambah(){
    ...
    var html = '<tr id="'+jml+'"><td><input type="text" name="nama_kemasan[]" class="text-white" placeholder="Nama Kemasan*" required></td>';
