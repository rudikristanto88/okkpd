        ...
        <div class="col-xl-6 col-lg-5 col-md-4 col-sm-12">
          <ul class="breadcrumb breadcrumb-style">
            <li class="breadcrumb-item 	bcrumb-1">
              ...
              <li class="breadcrumb-item active">Unggah dokumen prima 3</li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <div class="row clearfix">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                  <div class="header">
                    <h2>
                      <strong>Dokumen Prima 3</strong></h2><br>
                    ...
                    <div class="body">
                      ...
                      <form id="wizard_with_validation" action="<?= base_url() ?>dashboard/uploadDokumen" method="POST" class="wizard_custom" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="jenis" value="prima_3">
                        <h3>Unduh Surat Pernyataan Kesanggupan </h3>
                        <fieldset>
                          <a href="<?= base_url() ?>dokumen/form_kesanggupan/prima_3/<?= $id_layanan ?>" target="_blank" class="btn btn-info">Unduh <span class="fas fa-download"></span></a>
                        </fieldset>
