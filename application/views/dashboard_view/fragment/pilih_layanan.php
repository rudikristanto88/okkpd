      ...
      <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card">
                <a href="<?= base_url('dashboard/kelola_form/'.$jenis.'/prima_3') ?>">
                  <div class="image-180">
            ...
            <div class="col-md-4">
              <div class="card">
                <a href="<?= base_url('dashboard/kelola_form/'.$jenis.'/prima_2') ?>">
                  <div class="image-180">
            ...
            <div class="col-md-4">
              <div class="card">
                <a href="<?= base_url('dashboard/kelola_form/'.$jenis.'/psat') ?>">
                  <div class="image-180">
            ...
            <div class="col-md-4">
              <div class="card">
                <a href="<?= base_url('dashboard/kelola_form/'.$jenis.'/kemas') ?>">
                  <div class="image-180">
            ...
            <div class="col-md-4">
              <div class="card">
                <a href="<?= base_url('dashboard/kelola_form/'.$jenis.'/hc') ?>">
                  <div class="image-180">
          ...
          <!-- <div class="row"> -->
            ...
            foreach ($layanan as $layanan): ?>
              <div class="col-md-4">
                <div class="card">
                  <a href="<?= base_url('dashboard/kelola_form/'.$jenis.'/'.$layanan['kode_layanan']) ?>">
                    <div class="image-200">
                      <img class="card-img-top " src="https://vignette.wikia.nocookie.net/geometry-wars/images/0/0e/Camera_icon.png/revision/latest?cb=20151005154117" alt="Card image">
                    </div>
                    <div class="card-body">
                      <div class="text-center">
                        <h4 class="card-title">Pendaftaran <?= $layanan['nama_layanan'] ?></h4>
                      </div>
                    </div>
                  </a>
