    ...
    <div class="block-header">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
          <ul class="breadcrumb breadcrumb-style">
            <li class="breadcrumb-item 	bcrumb-1">
              ...
              <li class="breadcrumb-item active">Prima 2</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="card">
            <div class="body">
              <h2 class="card-inside-title">Prima 2</h2>
              <form class="" action="<?= base_url("dashboard/insert/prima_2") ?>" class="text-white" method="post">
                ...
                <div class="row clearfix">
                  ...
                  <div class="col-sm-12">
                    <div class="input-field">
                      <input type="hidden" name="kode_layanan" value="prima_2" readonly>
